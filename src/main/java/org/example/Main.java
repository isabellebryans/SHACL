...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Model dataGraph = load_data.initAndLoadModelFromResource("db_incorrect.ttl", Lang.TURTLE);

        //Read shapes data from file and load RDF model with shapes constraints
        Model shapesGraph = load_data.initAndLoadModelFromResource("shapes.ttl", Lang.TURTLE);
